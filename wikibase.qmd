...
[![sad](png/wikibase/EU-academy-course/EU-knowledge-graph.png){fig-align="center"}](https://linkedopendata.eu/wiki/The_EU_Knowledge_Graph)
...
\- \[x\] Wikimedia Deutschland (WMDE), the maintainer of Wikibase, has made considerable investments in optimising the software's use outside of Wikidata or other Wikimedia projects. 

\- \[x\] The EU Knowledge graph runs on Wikibase.

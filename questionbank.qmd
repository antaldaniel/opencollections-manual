...
![This question item (with answers) is taken from the Eurobarometer questionnaire x.x (QD refers to the D question block.)](png/question_to_wikibase/question_simple_2x1.png){fig-align="center"}
...
![This question is taken from the question block D (QD) from the Eurobarometer x.x. study.](png/question_to_wikibase/matrix_question.png){fig-align="center"}
...
![This questionnaire item is taken from the question block A (QA) of the Eurobarometer x.x. study.](png/question_to_wikibase/question_multipleChoice_6x4.png){fig-align="center"}
